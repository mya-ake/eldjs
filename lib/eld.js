...
Eld.prototype.create = function(tag, targetElem) {
...
Eld.prototype.selectTag = function(tagName, targetElem) {
  if (!targetElem) {
    targetElem = document;
  }
...
Eld.prototype.selectClass = function(className, targetElem) {
  if (!targetElem) {
    targetElem = document;
  }
...
Eld.prototype.select = function(query, targetElem) {
  if (!targetElem) {
    targetElem = document;
  }
...
EldObject.prototype.get = function(num) {
  return this.elems[num];
};

EldObject.prototype.parent = function() {
  var elems = [];
...
EldObject.prototype.children = function() {
  var elems = [];
  for (var i = 0; i < this.length; i++) {
...
EldObject.prototype.text = function(text) {
  var i;
...
EldObject.prototype.val = function(value) {
  var i;
...
EldObject.prototype.gval = function(value) {
  var t = this;
  if (value !== undefined) {
    if (this.length === 1) {
      setOne(value);
...
EldObject.prototype.style = function() {
  var t = this;
...
EldObject.prototype.attr = function() {
  var t = this;
  switch (arguments.length) {
    case 1:
      return f1(arguments[0]);
...
EldObject.prototype.prop = function() {
  var t = this;
  switch (arguments.length) {
    case 1:
      return f1(arguments[0]);
...
EldObject.prototype.class = function() {
  var t = this;
...
EldObject.prototype.animate = function(param, duration, timing, delay, callback) {
  var t = this;
  var origin = {
    duration: [],
    timing: [],
...
EldObject.prototype.event = function(name, func, flg) {
  var i = this.length - 1;
  if (flg === false) {
    for (; i >= 0; i--) {
    ...
    for (; i >= 0; i--) {
      this.elems[i].addEventListener(name, func, false);
    }
  }
  return this;
};

EldObject.prototype.insertInner = function(html, position) {
...
EldObject.prototype.insertBefore = function(html) {
  if (typeof html !== "string") {
    return this;
  }
  for (var i = this.length - 1; i >= 0; i--) {
...
EldObject.prototype.insertAfter = function(html) {
  if (typeof html !== "string") {
    return this;
  }
  for (var i = this.length - 1; i >= 0; i--) {
...
EldObject.prototype.html = function(html) {
  var i;
  if (typeof html !== "string") {
    if (this.length === 1) {
...
EldObject.prototype.createChild = function(tag, params) {
...
EldObject.prototype.merge = function() {
  var newElems = [];
  var i;
  for (i = 0; i < this.length; i++) {
